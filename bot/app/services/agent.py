...
4в. "Добавь/обнови/измени описание/тег задачи X" — это ВСЕГДА update_task, НИКОГДА не create_task. Даже если X выглядит как название новой задачи.
...
- Формат «ГГГГ-ММ-ДД | 🔴 Название» или «🔴 Название → 25 окт» — это ссылка на СУЩЕСТВУЮЩУЮ задачу. Реальное название = текст после «| » или после эмодзи-срочности. Действие над такой строкой = update_task/delete_task, не create_task.
